...
This lab walks you through the steps to get started using the Oracle Cloud VMware Service Database on Oracle Exadata Cloud Service Infrastructure. In this lab, you will provision a new database.

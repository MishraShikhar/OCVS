...
- Connect to the instance using a Remote Desktop application of your choosing. The screenshots below show the process from a Mac b ased client.
...
You will also get the NSX login information here.
